...
export const ONBOARDING_QUESTIONS: OnboardingQuestion[] = [
  ...
  { id: "equity_release", prompt: "Equity you would release from a property you already own (AUD)? Borrowed money, so it carries servicing unlike cash.", type: "number", optional: true },
  { id: "equity_rate_pct", prompt: "Interest rate on that released equity (%)? (defaults to a standard mortgage rate)", type: "number", optional: true },
  { id: "property_value", prompt: "If you own a property, its value (AUD)? (used to estimate usable equity at 80% LVR)", type: "number", optional: true },
  { id: "property_mortgage", prompt: "Outstanding mortgage on that property (AUD)?", type: "number", optional: true },
...
export function profileFromAnswers(a: OnboardingAnswers): BuyerProfile {
  ...
  const profile: BuyerProfile = {
    ...
    finances: {
      ...
      property_mortgage: num("property_mortgage"),
