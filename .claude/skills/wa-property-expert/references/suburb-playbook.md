...
Anchor: **Como 6152.** Budget: **$800k–$1.0M** for a **house** on **450sqm+**,
...
- **Bayswater (~$980k–1.18M)** — METRONET hub, gentrifying, near the river;
  borderline budget.
- **Embleton (~$900–970k)** / **Balcatta (~$910–970k)** — 450sqm+ green-title,
  KDR upside.
...
Posture: **patient/opportunistic** — the $800k-at-0% facility removes the cost of
...
- **Confirm 450sqm+** via Landgate cadastre (no public median block size exists).
